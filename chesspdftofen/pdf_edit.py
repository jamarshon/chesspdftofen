# From https://github.com/plangrid/pdf-annotate while waiting for PR to merge
...
pdf_edit = pdf_annotate

pdf_edit.annotator.NAME_TO_ANNOTATION['note'] = NoteText
...
# DEFAULT_TEXT_ANNOT_NAME = 'Note'
# pdf_edit.config.appearance.Appearance.text_name = String(default=DEFAULT_TEXT_ANNOT_NAME)

pdf_edit.Appearance = Appearance